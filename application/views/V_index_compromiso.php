            ...
            <div class="row align-items-center text-center text-md-left">
                <div class="col-md-6 mb-5 mb-md-0 appear-animation" data-appear-animation="fadeInRightShorter"
                    ...
                    <p>
                        ...
                        comunicación entre el Gobierno del Estado y los diferentes sectores en Yucatán para la
        ...
        <div class="container">
            <div class="row align-items-center text-center text-md-left">
                ...
                <div class="col-md-6 mb-5 mb-md-0 appear-animation" data-appear-animation="fadeInRightShorter"
                    ...
                    <h2 class="font-weight-bold text-7 line-height-1 ls-0 mb-3">Plan estratégico de Yucatán</h2>

                    <p style="">La asociación civil, en la que participan hoy día 23 entidades comprometidas con el
                        futuro de Yucatán, colabora con sus opiniones y propuestas en la búsqueda de soluciones a
                        los problemas que afectan el desarrollo de la estado y de sus habitantes.

                    </p>
                    <a href="#" class="btn btn-primary font-weight-semibold rounded-0 text-2 btn-px-5 btn-py-2">Visitar</a>
