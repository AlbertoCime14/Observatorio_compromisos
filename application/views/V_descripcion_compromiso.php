        ...
        <div class="row">
            ...
            <div class="col-lg-6" >
                ...
                <div class="summary entry-summary">
                    ...
                    <a class=" text-color-primary" style="font-size: 16px" download="" href="https://www.anerbarrena.com/demos/2016/014-audio-helicoptero.mp3">Enlace para descargar la ficha técnica</a>
            ...
            <div class="col">
                <div class="tabs tabs-product mb-2">
                    <ul class="nav nav-tabs">
                        <li class="nav-item active"><a class="nav-link py-3 px-4" href="#productDescription" data-toggle="tab">Metas de cumplimiento</a></li>
                        <li class="nav-item"><a class="nav-link py-3 px-4" href="#productInfo" data-toggle="tab">Evidencia</a></li>

                    </ul>
                    <div class="tab-content p-0">
                        <div class="tab-pane p-4 active" id="productDescription">
                            <label style="margin-bottom: 0px"><strong>Escuelas con conectividad </strong></label>
                            <br>
                            <label style="color: #000; margin-top: 0px !important;"><strong>Avance:</strong></label>
                            <label style="color: #000;"><strong>20%</strong></label>
                            ...
                            <div class="col-lg-12 mb-4 mb-lg-0">
                                ...
                                <div class="accordion accordion-modern" id="accordion10">
                                    <div class="card card-default">
                                        <div class="card-header">
                                            <h4 class="card-title m-0">
                                                <a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-toggle="collapse" data-parent="#accordion10" href="#collapse10One" aria-expanded="false">
                                        ...
                                        <div id="collapse10One" class="collapse" style="">
                                            <div class="card-body" >
                                                <strong style="font-size: 14px " class="text-color-primary">Documento:</strong>
                                                <i class="fas fa-file-pdf" style="font-size: 25px;">

                                                </i>
                                                <a class=" text-color-primary" style="font-size: 14px" download="" href="https://www.anerbarrena.com/demos/2016/014-audio-helicoptero.mp3">Enlace de descarga</a>
                                                <br>
                                                <strong style="font-size: 14px" class="text-color-primary">Documento:</strong>
                                                <i class="fas fa-file-pdf" style="font-size: 25px;">
                                    ...
                                    <div class="card card-default">
                                        <div class="card-header">
                                            <h4 class="card-title m-0">
                                                <a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-toggle="collapse" data-parent="#accordion10" href="#collapse10Two" aria-expanded="false">
                                        ...
                                        <div id="collapse10Two" class="collapse" style="">
                                            <div class="card-body">
                                                <div class="owl-carousel owl-theme stage-margin owl-loaded owl-drag owl-carousel-init" data-plugin-options="{'items': 6, 'margin': 10, 'loop': false, 'nav': true, 'dots': false, 'stagePadding': 40}" style="height: auto;">
                                                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1814px; padding-left: 40px; padding-right: 40px;"><div class="owl-item active" style="width: 163.333px; margin-right: 10px;"><div>
                                                                    <<?=base_url();?> alt="" class="img-fluid rounded" src="<?=base_url();?>img/projects/project-5.jpg">
                                                                </div></div><div class="owl-item active" style="width: 163.333px; margin-right: 10px;"><div>
                                                                    <img alt="" class="img-fluid rounded" src="<?=base_url();?>img/projects/project-6.jpg">
                                                                </div></div><div class="owl-item active" style="width: 163.333px; margin-right: 10px;"><div>
                                                                    <img alt="" class="img-fluid rounded" src="<?=base_url();?>img/projects/project-7.jpg">
                                                                </div></div><div class="owl-item active" style="width: 163.333px; margin-right: 10px;"><div>
                                                                    <img alt="" class="img-fluid rounded" src="<?=base_url();?>img/projects/project-1.jpg">
                                                                </div></div><div class="owl-item active" style="width: 163.333px; margin-right: 10px;"><div>
                                                                    <img alt="" class="img-fluid rounded" src="<?=base_url();?>img/projects/project-2.jpg">
                                                                </div></div><div class="owl-item active" style="width: 163.333px; margin-right: 10px;"><div>
                                                                    <img alt="" class="img-fluid rounded" src="<?=base_url();?>img/projects/project-3.jpg">
                                                                </div></div><div class="owl-item" style="width: 163.333px; margin-right: 10px;"><div>
                                                                    <img alt="" class="img-fluid rounded" src="<?=base_url();?>img/projects/project-1.jpg">
                                                                </div></div><div class="owl-item" style="width: 163.333px; margin-right: 10px;"><div>
                                                                    <img alt="" class="img-fluid rounded" src="<?=base_url();?>img/projects/project-2.jpg">
                                                                </div></div><div class="owl-item" style="width: 163.333px; margin-right: 10px;"><div>
                                                                    ...
                                                                    <img alt="" class="img-fluid rounded" src="<?=base_url();?>img/projects/project-4.jpg">
                                    ...
                                    <div class="card card-default">
                                        <div class="card-header">
                                            <h4 class="card-title m-0">
                                                <a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-toggle="collapse" data-parent="#accordion10" href="#collapse10Three" aria-expanded="false">
                                            ...
                                            <div class="card-body">
                                                <div class="embed-responsive-borders">
                                                    <div class="embed-responsive embed-responsive-16by9">
                                                        <iframe width="100" height="100" frameborder="0" allowfullscreen="" src="http://www.youtube.com/embed/l-epKcOA7RQ?showinfo=0&amp;wmode=opaque"></iframe>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
