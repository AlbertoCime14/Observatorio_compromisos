...
<div role="main" class="main" style="margin-bottom: 100px">
    ...
    <div class="container py-2">
        ...
        <ul class="nav nav-pills sort-source sort-source-style-3 justify-content-center" data-sort-id="portfolio"
            ...
            <li class="nav-item active" data-option-value="*"><a class="nav-link text-1 text-uppercase active" style="color:black!important;    border-bottom-color: #073a54 !important;"
                                                                 href="#"><strong>Cumplidos</strong></a></li>
            <li class="nav-item" data-option-value=".websites"><a class="nav-link text-1 text-uppercase" href="#" style="color:black!important;"><strong>En proceso</strong></a>
            </li>
            <li class="nav-item" data-option-value=".logos"><a class="nav-link text-1 text-uppercase" style="color:black!important;"
